  ...
  <div class="col-lg-12">
    <div class="tabs-container">
      <ul class="nav nav-tabs">
        ...
        <li class="active"><a  href="<?php echo base_url('personalia/seleksi/wawancara') ?>">Wawancara</a></li>
      ...
      <div class="tab-content">
       <div id="tab-1" class="tab-pane active">
        ...
        <table class="table table-striped" id="table-wawancara">
          <thead>
            <tr>
             <th>NIK</th>
             <th>Nama</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content animated rubberBand">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Input Nilai Wawancara</h4>
        <h3 class="modal-title"><span id="last_jabatan"></span></h3>

      </div>
      <div class="modal-body">
        <form method="get" class="form-horizontal" id="form-wawancara">
          <input type="hidden" id="id_fakultas" name="id_fakultas">
          <input type="hidden" id="id_subbag" name="id_subbag">
          <input type="hidden" id="tahap" name="tahap" value="3">
          <div class="modal-body">
            <div id="wadah">
            </div>
          </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    table_wawancara = $('#table-wawancara').DataTable({ 
     "bLengthChange": false,
     ...
     "ajax": {
      "url": '<?php echo site_url('personalia/jsonDaftarNilai/wawancara'); ?>',
      "type": "POST"
    },
    "columns": [
    {"data": "nik"},
    ...
    initComplete: function() {
     ...
     $("div#administrasi")
     .html('<button class="btn btn-empty" id="btn-modal-wawancara" style="display:none" type="button">Input Nilai</button> &emsp; <button type="button" id="btn-show-seleksi" style="display:none" class="btn btn-warning" >Seleksi [+]</button> &emsp;<button class="btn btn-info" id="btn-cetak-wawancara" style="display:none" type="button">Cetak Data</button>');

     $('#btn-modal-wawancara').click(function(event) {
     ...
     $("#btn-cetak-wawancara").click(function(e){
     ...
     if (now > tanggal_ujian_wawancara) {
      $('#btn-show-seleksi').toggle();
      $('#btn-modal-wawancara').toggle();
      $('#btn-cetak-wawancara').toggle();
  ...
  "drawCallback" : function(settings) {
   ...
   if (!jQuery.isEmptyObject($("#total-seleksi").data("ionRangeSlider"))) 
   {
    ...
    $("#fakultas-subbag").change(function() {
      ...
      var url = '<?php echo site_url('personalia/jsonDaftarNilai/wawancara/'); ?>';
      table_wawancara.ajax.url(url + id_fakultas + "/" + id_subbag ).load();
    })
 ...
 */
 ...
 function showModals( last_jabatan )
 {
  ...
  $.ajax({
    ...
    dataType: 'json',
    data: {id_fakultas:id_fakultas, id_subbag:id_subbag,tahap : "3", tipe:"get"},
...
{
  var formData = $("#form-wawancara").serialize();
  showPleaseWait();
